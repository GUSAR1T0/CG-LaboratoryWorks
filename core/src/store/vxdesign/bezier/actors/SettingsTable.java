...
public class SettingsTable extends Table {
    ...
    public SettingsTable(Camera camera) {
        weight0 = new Label("Weight 0", SkinHandler.LABEL_STYLE);
        weight0.setAlignment(Align.center);
        weight0Slider = new Slider(-10, 10, 1, false, SkinHandler.SLIDER_STYLE);
        weight0Slider.setValue(1);
        weight0Info = new Label(Integer.toString((int) weight0Slider.getValue()), SkinHandler.LABEL_STYLE);
        ...
        weight1 = new Label("Weight 1", SkinHandler.LABEL_STYLE);
        weight1.setAlignment(Align.center);
        weight1Slider = new Slider(-10, 10, 1, false, SkinHandler.SLIDER_STYLE);
        weight1Slider.setValue(1);
        weight1Info = new Label(Integer.toString((int) weight1Slider.getValue()), SkinHandler.LABEL_STYLE);
        ...
        weight2 = new Label("Weight 2", SkinHandler.LABEL_STYLE);
        weight2.setAlignment(Align.center);
        weight2Slider = new Slider(-10, 10, 1, false, SkinHandler.SLIDER_STYLE);
        weight2Slider.setValue(1);
        weight2Info = new Label(Integer.toString((int) weight2Slider.getValue()), SkinHandler.LABEL_STYLE);
        ...
        step = new Label("Step", SkinHandler.LABEL_STYLE);
        step.setAlignment(Align.center);
        stepSlider = new Slider(0.001f, 1, 0.001f, false, SkinHandler.SLIDER_STYLE);
        stepInfo = new Label(Float.toString(stepSlider.getValue()), SkinHandler.LABEL_STYLE);
